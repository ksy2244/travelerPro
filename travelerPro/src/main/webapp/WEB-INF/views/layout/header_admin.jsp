    ...
    <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent" style="margin-right: 100px;">
      <ul class="navbar-nav mb-2 mb-lg-0">
	        ...
	        <li class="nav-item dropdown">
	          ...
	          <ul class="dropdown-menu">
	            <li><a class="dropdown-item" href="${pageContext.request.contextPath}/answer/faq.do" style="font-family: 'GmarketSans';">자주 묻는 질문 FAQ</a></li>
	            <li><a class="dropdown-item" href="${pageContext.request.contextPath}/answer/qnaList.do" style="font-family: 'GmarketSans';">1:1 문의</a></li>
	          </ul>
	        </li>
	        
      		<li class="nav-item text-white">
	          	<a class="nav-link text-white" href="${pageContext.request.contextPath}/notice/list.do" title="공지 관리"
	          		style="font-family: 'GmarketSans'; font-size: 25px; margin-top: 6px; margin-right: 20px;">공지관리</a>
	        </li>
	      	<li class="nav-item text-white">
	          	<a class="nav-link text-white" href="${pageContext.request.contextPath}/coupon/list.do" title="쿠폰 관리" 
	          		style="font-family: 'GmarketSans'; font-size: 25px; margin-top: 6px; margin-right: 20px;">쿠폰관리</a>
	        </li>
    	</ul>
    </div>
  </div>
