...
<nav class="navbar navbar-expand-lg justify-content-end"
	style="background: #B8B5FF; border: 30px solid #B8B5FF;">
	<div class="container-fluid">
		<a class="navbar-brand text-white" href="#"
			style="font-family: 'GmarketSans'; font-size: 50px; margin-left: 300px;">
			<i class="fa-regular fa-paper-plane">TRAVELER</i>
		</a>
		...
		<div class="collapse navbar-collapse justify-content-end"
			id="navbarSupportedContent" style="margin-right: 350px;">
			<ul class="navbar-nav mb-2 mb-lg-0">
				<li class="nav-item dropdown"><a
					class="nav-link dropdown-toggle fw-semibold text-white" href="#"
					role="button" data-bs-toggle="dropdown" aria-expanded="false"
					style="font-family: 'GmarketSans'; font-size: 25px; margin-right: 20px;">
						더보기 </a>
					<ul class="dropdown-menu">
						<li><a class="dropdown-item" href="#"
							style="font-family: 'GmarketSans';">자주 묻는 질문 FAQ</a></li>
						<li><a class="dropdown-item" href="#"
							style="font-family: 'GmarketSans';">1:1 문의</a></li>
						<li><a class="dropdown-item" href="#"
							style="font-family: 'GmarketSans';">공지사항</a></li>
						<li><a class="dropdown-item" href="#"
							style="font-family: 'GmarketSans';">약관 및 정책</a></li>
					</ul></li>
				<c:if test="${empty sessionScope.member}">
					<li class="nav-item"><a
						class="nav-link fw-semibold text-white"
						href="javascript:dialogLogin();" title="로그인"
						style="font-family: 'GmarketSans'; font-size: 25px; margin-top: 6px; margin-right: 20px;">로그인</a>
					</li>
					<li class="nav-item"><a
						class="nav-link fw-semibold text-white" href="#" title="회원가입"
						style="font-family: 'GmarketSans'; font-size: 25px; margin-top: 6px; margin-right: 20px;">회원가입</a>
					</li>
				</c:if>
				<c:if test="${not empty sessionScope.member}">
					<li class="nav-item fw-semibold text-white"><a
						class="nav-link fw-semibold text-white"
					...
					<li class="nav-item fw-semibold text-white"><a
						class="nav-link fw-semibold text-white" href="#" title="마이페이지"
				...
				<div class="p-3">
					<form name="modelLoginForm" action="" method="post" class="row g-3">
						...
						<div>
							<button type="button" class="btn w-100"
								onclick="sendModelLogin();" style="background: #EDEEF7">Login</button>
						</div>
						<div>
					...
					<div>
						<p class="form-control-plaintext mb-0">
							아직 회원이 아니세요 ? <a href="${pageContext.request.contextPath}/"
					...
					<div>
						<p class="form-control-plaintext mb-1">
							<a href="/traveler/member/company.do/"
								class="text-decoration-none">사업장 등록하기</a>
						</p>
					</div>
				</div>
			</div>
