...
<!-- 여기서 필요한 css는 article에 여기는 script, html 잇음 안됨 -->
<!-- AJAX를 통해 하기 코드를 불러옴 -->
	        ...
	        <td colspan='2'>
	            ...
	            <div class="answer-form">
	             ...
	             <div class='answer-footer'>
	                <button type='button' class='btn btn-light btnSendReplyAnswer' data-replyNum='${vo.replyNum}'>답글 등록</button> <!-- data-replyNum은 아버지 번호 -->
	            </div>
			</td>
	    </tr>
	</c:forEach>
