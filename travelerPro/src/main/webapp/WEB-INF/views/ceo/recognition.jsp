			...
			<div class="body-main">
				<form name="companyForm" method="post" enctype="multipart/form-data">
					...
					<div class="row mb-3">
				        ...
				        <div class="col-sm-10 row">
							<div class="col-sm-3 pe-2">
								<input type="text" name="businessNum1" id="businessNum1" class="form-control" value="${dto.businessNum1}" maxlength="3" placeholder="사업자번호">
							</div>
				        ...
				        <div class="col-sm-10 row">
							<div class="col-3 pe-0">
								<select name="checkinTime" id="checkinTime" class="form-select" onchange="changeEmail();">
									...
									<option value="9시" ${dto.checkinTime=="9시" ? "selected='selected'" : ""}>9시</option>
									<option value="10시" ${dto.checkinTime=="10시"? "selected='selected'" : ""}>10시</option>
									<option value="11시" ${dto.checkinTime=="11시" ? "selected='selected'" : ""}>11시</option>
									<option value="12시" ${dto.checkinTime=="12시" ? "selected='selected'" : ""}>12시</option>
									<option value="13시" ${dto.checkinTime=="13시" ? "selected='selected'" : ""}>13시</option>
									<option value="14시" ${dto.checkinTime=="14시" ? "selected='selected'" : ""}>14시</option>
									<option value="15시" ${dto.checkinTime=="15시" ? "selected='selected'" : ""}>15시</option>
								</select>
							</div>
						</div>
					</div>
				        ...
				        <div class="col-sm-10 row">
							<div class="col-3 pe-0">
								<select name="checkoutTime" id="checkoutTime" class="form-select" onchange="changeEmail();">
									<option value="">선 택</option>
									<option value="9시" ${dto.checkoutTime=="9시" ? "selected='selected'" : ""}>9시</option>
									<option value="10시" ${dto.checkoutTime=="10시" ? "selected='selected'" : ""}>10시</option>
									<option value="11시" ${dto.checkoutTime=="11시" ? "selected='selected'" : ""}>11시</option>
									<option value="12시" ${dto.checkoutTime=="12시" ? "selected='selected'" : ""}>12시</option>
									<option value="13시" ${dto.checkoutTime=="13시" ? "selected='selected'" : ""}>13시</option>
									<option value="14시" ${dto.checkoutTime=="14시" ? "selected='selected'" : ""}>14시</option>
									<option value="15시" ${dto.checkoutTime=="15시" ? "selected='selected'" : ""}>15시</option>
								</select>
							</div>
						</div>
					</div>
				    <div class="row mb-3">
				        ...
				        <div class="col-sm-10 row">
							<div class="col-sm-3 pe-2">
								<input type="text" name="tel1" id="tel1" class="form-control" value="${dto.companyTel1}" maxlength="3">
							</div>
							<div class="col-sm-1 px-1" style="width: 2%;">
								<p class="form-control-plaintext text-center">-</p>
							</div>
				    ...
				    <div class="row mb-3">
				        <div class="text-center">
				            <button type="button" name="sendButton" class="btn btn-primary" onclick="companyOk();">${mode=='update'? '수정완료':'승인받기'}&nbsp;<i class="bi bi-check2"></i></button>
				            <button type="reset" class="btn btn-primary">다시입력</button>
				            <button type="button" class="btn btn-primary" onclick="location.href='${pageContext.request.contextPath}/ceo/main.do';">${mode=='update'?'수정취소':'승인취소'}&nbsp;<i class="bi bi-x"></i></button>
