					...
					<form name="memberForm" method="post">
						...
						<div class="row mb-3">
							...
							<div class="row mb-3">
								...
								<div class="col-sm-10">
									<input type="password" name="userPwd" id="userPwd"
										...
										class="form-control-plaintext">비밀번호는 5~10자이며 하나 이상의
							...
							<div class="row mb-3">
								...
								<div class="col-sm-10">
									...
									<small class="form-control-plaintext">비밀번호를 한번 더
										입력해주세요.</small>
								</div>
							</div>
						...
						<div class="row mb-3">
							<div class="text-center">
								<button type="button" name="sendButton" class="btn btn-danger text-white"
									onclick="memberOk();" >
									${mode=="member"?"회원가입":"정보수정"}</button>
								<button type="button" class="btn"
									onclick="location.href='${pageContext.request.contextPath}/';"
									>
									${mode=="member"?"가입취소":"취소"}<i class="bi bi-x"></i></button>
