...
<script type="text/javascript">
	function memberOk() {
		...
		f.action = "${pageContext.request.contextPath}/mypage/${mode}_ok.do";
		f.submit();
	}
				...
				<div class="body-main">
					...
					<form name="memberForm" method="post">
						...
						<div class="row mb-3">
							...
							<div class="col-sm-10">
								<input type="password" name="userPwd" id="userPwd" value="${dto.userPwd}" 
									class="form-control" autocomplete="off" placeholder="패스워드" >
								<small class="form-control-plaintext">비밀번호는 5~10자이며 하나
						...
						<div class="row mb-3">
							...
							<div class="col-sm-10">
								<input type="password" name="userPwd2" id="userPwd2"
									class="form-control" autocomplete="off" placeholder="비밀번호 확인" style="border: none">
						...
						<div class="row mb-3">
							...
							<div class="col-sm-10">
								<input type="date" name="birth" id="birth" class="form-control"
									value="${dto.birth}" placeholder="${dto.birth}" style="border: none"> <small
						...
						<div class="row mb-3">
							<div class="text-center">
								<button type="button" name="sendButton" class="btn"
									onclick="memberOk();" style="background: #B8B5FF">
									${mode=="member"?"회원가입":"정보수정"}
								</button>
								<button type="button" class="btn"
									onclick="location.href='${pageContext.request.contextPath}/';"
									style="background: #EDEEF7">
									${mode=="member"?"가입취소":"수정취소"}
								</button>
