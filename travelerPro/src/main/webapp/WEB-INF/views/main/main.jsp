	...
	<main class="container pt-5">
		...
		<div class="box">
			...
			<div class="region-button">
				<button class="seoul" type="submit" onclick="location.href='${pageContext.request.contextPath}/attraction/list.do?areacode=1&region=서울'"><div style="color: red;"><i class="fa-solid fa-location-dot fa-2x"></i></div>서울</button>
				<button class="incheon" type="submit" onclick="location.href='${pageContext.request.contextPath}/attraction/list.do?areacode=2&region=인천'"><div style="color: red;"><i class="fa-solid fa-location-dot fa-2x"></i></div>인천</button>
				<button class="sejeong" type="submit" onclick="location.href='${pageContext.request.contextPath}/attraction/list.do?areacode=8&region=세종'"><div style="color: red;"><i class="fa-solid fa-location-dot fa-2x"></i></div>세종</button>
				<button class="guynggi" type="submit" onclick="location.href='${pageContext.request.contextPath}/attraction/list.do?areacode=31&region=경기도'"><div style="color: red;"><i class="fa-solid fa-location-dot fa-2x"></i></div>경기도</button>
				<button class="gangwon" type="submit" onclick="location.href='${pageContext.request.contextPath}/attraction/list.do?areacode=32&region=강원도'"><div style="color: red;"><i class="fa-solid fa-location-dot fa-2x"></i></div>강원도</button>
				<button class="daejeon" type="submit" onclick="location.href='${pageContext.request.contextPath}/attraction/list.do?areacode=3&region=대전'"><div style="color: red;"><i class="fa-solid fa-location-dot fa-2x"></i></div>대전</button>
				<button class="daegu" type="submit" onclick="location.href='${pageContext.request.contextPath}/attraction/list.do?areacode=4&region=대구'"><div style="color: red;"><i class="fa-solid fa-location-dot fa-2x"></i></div>대구</button>
				<button class="gwangju" type="submit" onclick="location.href='${pageContext.request.contextPath}/attraction/list.do?areacode=4&region=광주'"><div style="color: red;"><i class="fa-solid fa-location-dot fa-2x"></i></div>광주</button>
				<button class="busan" type="submit" onclick="location.href='${pageContext.request.contextPath}/attraction/list.do?areacode=6&region=부산'"><div style="color: red;"><i class="fa-solid fa-location-dot fa-2x"></i></div>부산</button>
				<button class="wulsan" type="submit" onclick="location.href='${pageContext.request.contextPath}/attraction/list.do?areacode=7&region=울산'"><div style="color: red;"><i class="fa-solid fa-location-dot fa-2x"></i></div>울산</button>
				<button class="chungbuk" type="submit" onclick="location.href='${pageContext.request.contextPath}/attraction/list.do?areacode=33&region=충청북도'"><div style="color: red;"><i class="fa-solid fa-location-dot fa-2x"></i></div>충청북도</button>
				<button class="chungnam" type="submit" onclick="location.href='${pageContext.request.contextPath}/attraction/list.do?areacode=34&region=충청남도'"><div style="color: red;"><i class="fa-solid fa-location-dot fa-2x"></i></div>충청남도</button>
				<button class="gyungnam" type="submit" onclick="location.href='${pageContext.request.contextPath}/attraction/list.do?areacode=36&region=경상남도'"><div style="color: red;"><i class="fa-solid fa-location-dot fa-2x"></i></div>경상남도</button>
				<button class="gyungbuk" type="submit" onclick="location.href='${pageContext.request.contextPath}/attraction/list.do?areacode=35&region=경상북도'"><div style="color: red;"><i class="fa-solid fa-location-dot fa-2x"></i></div>경상북도</button>
				<button class="jeonbuk" type="submit" onclick="location.href='${pageContext.request.contextPath}/attraction/list.do?areacode=37&region=전라북도'"><div style="color: red;"><i class="fa-solid fa-location-dot fa-2x"></i></div>전라북도</button>
				<button class="jeonnam" type="submit" onclick="location.href='${pageContext.request.contextPath}/attraction/list.do?areacode=38&region=전라남도'"><div style="color: red;"><i class="fa-solid fa-location-dot fa-2x"></i></div>전라남도</button>
				<button class="jeju" type="submit" onclick="location.href='${pageContext.request.contextPath}/attraction/list.do?areacode=39&region=제주도'"><div style="color: red;"><i class="fa-solid fa-location-dot fa-2x"></i></div>제주도</button>
			</div>
				<div class="api-list">
					<hr style="color: #787878; width: 1300px;">
					<div class="click">지역별 추천 관광지 미리보기
						<span>
					...
					<div class="search-container">
						<form class="row justify-content-center" method="get">
							...
							<div class="col-auto p-1">
								<button type="button" class="btn btnSearchOk"> <i class="fa-solid fa-magnifying-glass"></i> </button> 
							</div>
							<div class="col-auto p-1">
								<button type="button" class="btn btnSearchInit"> <i class="fa-solid fa-rotate-right"></i> </button>
							</div>
						</form>
					</div>
