...
<link rel="shortcut icon" type="image/x-icon"
	href="${pageContext.request.contextPath}/resources/images/title2.png" />
		...
		$('#start_date').datepicker(
				{
					...
					onClose : function(selectedDate) {
						...
						var date = new Date(select[0], select[1] - 1,
								parseInt(select[2]) + 1);
...
<script type="text/javascript">
	$(function() {
		let u = "${pageContext.request.contextPath}/reservation/roomList.do?companyNum=${companyNum}&start_date=${start_date}&end_date=${end_date}&tmp="
				+ new Date().getTime();
		$("#nav-1").load(u);
			...
			<div class="carousel-inner" data-bs-interval="100"
				...
				<c:forEach var="imgList" items="${imgList}">
					<div class="carousel-item">
						<img class="roomImg"
							src="${pageContext.request.contextPath}/uploads/room/${imgList.imageFileName}"
							class="d-block w-100 bestRegion" alt="...">
						<div class="carousel-caption d-none d-md-block"></div>
					</div>
				</c:forEach>
			...
			<div class="body-title">
				...
				<div class="border-secondary mb-3">
					<div class="shadowBox" style="width: 1100px; height: 1400px;">
						<span class="trip"> <a class="btn gray"
							data-bs-toggle="collapse" href="#collapseExample" role="button"
							aria-expanded="false" aria-controls="collapseExample"> <img
								src="${pageContext.request.contextPath}/resources/images/한국관광공사.png"
								style="width: 14px;" class="imgg">&nbsp;<span class="ok">인증</span>
						</a>
						</span>

						<div class="collapse" id="collapseExample">
							<div class="card card-body">한국관광공사에서 인증한 숙소 등급입니다.</div>
						</div>
						<h4 class="name mt-3 mb-3">${companyDto.companyName}</h4>
						<span style="float: right;"><button type="button"
								class="btn btnSendCompanyLike like" title="좋아요">
								<i class="fa-sharp fa-solid fa-heart fa-2x"
									style="color: ${isUserLike?'red':'black'}"></i>&nbsp;&nbsp;<span
									id="companyLikeCount">${companyDto.pick}</span>
							</button></span>
						<c:choose>
							<c:when test="${companyDto.starRate > 4.5}">
								<span class="star"><i class="fa-solid fa-star fa-2x"></i><i
									class="fa-solid fa-star fa-2x"></i><i
									class="fa-solid fa-star fa-2x"></i><i
									class="fa-solid fa-star fa-2x"></i><i
									class="fa-solid fa-star fa-2x"></i>&nbsp;<span class="bold">${companyDto.starRate}
										(${count})</span></span>
							</c:when>
							<c:when test="${companyDto.starRate > 4.0}">
								<span class="star"><i class="fa-solid fa-star fa-2x"></i><i
									...
									class="fa-solid fa-star fa-2x"></i><i
									class="fa-solid fa-star fa-2x"></i><i
									class="fa-solid fa-star-half fa-2x"></i>&nbsp;<span
									class="bold">${companyDto.starRate} (${count})</span></span>
							</c:when>
							...
							<c:when test="${companyDto.starRate > 0.5}">
								<span class="star"><i class="fa-solid fa-star fa-2x"></i>&nbsp;<span
									class="bold">${companyDto.starRate} (${count})</span></span>
							</c:when>
							<c:when test="${companyDto.starRate > 0}">
								<span class="star"><i class="fa-solid fa-star-half fa-2x"></i>&nbsp;<span
									class="bold">${companyDto.starRate} (${count})</span></span>
							</c:when>
							<c:otherwise>
								<span class="star"><i class="fa-regular fa-star fa-2x"></i>&nbsp;<span
									class="bold">${companyDto.starRate} (${count})</span></span>
							</c:otherwise>
						</c:choose>
						<br> <br>
						<div>
							<i class="fa-solid fa-phone fa-lg"></i>&nbsp;<span
								class="address">숙소문의</span>&nbsp;&nbsp; <i
								class="fa-solid fa-location-dot fa-lg ps-3"></i>&nbsp;<span
								class="address">${companyDto.addr}&nbsp;${companyDto.addrDetail}</span>
						</div>
						<br>
								...
								<c:choose>
									<c:when test="${service == 1}">
										<div class="col-1" style="text-align: center;">
											<img
												src="${pageContext.request.contextPath}/resources/images/service/wifi.png"
												class="png">
											<p>와이파이</p>
										</div>
									</c:when>
									<c:when test="${service == 2}">
										<div class="col-1" style="text-align: center;">
											<img
												src="${pageContext.request.contextPath}/resources/images/service/pet.png"
												class="png">
											<p>반려동물</p>
										</div>
									</c:when>
									<c:when test="${service == 3}">
										<div class="col-1" style="text-align: center;">
											<img
												src="${pageContext.request.contextPath}/resources/images/service/meat.png"
												class="png">
											<p>바베큐</p>
										</div>
									</c:when>
									<c:when test="${service== 4}">
										<div class="col-1" style="text-align: center;">
											<img
												src="${pageContext.request.contextPath}/resources/images/service/pool.png"
												class="png">
											<p>수영장</p>
										</div>
									</c:when>
									<c:when test="${service == 5}">
										<div class="col-1" style="text-align: center;">
											<img
												src="${pageContext.request.contextPath}/resources/images/service/park.png"
												class="png">
											<p>주차 가능</p>
										</div>
									</c:when>
									<c:when test="${service == 6}">
										<div class="col-1" style="text-align: center;">
											<img
												src="${pageContext.request.contextPath}/resources/images/service/medicine.png"
												class="png">
											<p>상비약</p>
										</div>
									</c:when>
									<c:when test="${service == 7}">
										<div class="col-1" style="text-align: center;">
											<img
												src="${pageContext.request.contextPath}/resources/images/service/source.png"
												class="png">
											<p>양념</p>
										</div>
									</c:when>
									<c:when test="${service == 8}">
										<div class="col-1" style="text-align: center;">
											<img
												src="${pageContext.request.contextPath}/resources/images/service/store.png"
												class="png">
											<p style="font-size: 11px;">매점/편의점</p>
										</div>
									</c:when>
									<c:when test="${service== 9}">
										<div class="col-1" style="text-align: center;">
											<img
												src="${pageContext.request.contextPath}/resources/images/toast.png"
												class="png">
											<p>조식 제공</p>
										</div>
									</c:when>
									<c:when test="${service == 10}">
										<div class="col-1" style="text-align: center;">
											<img
												src="${pageContext.request.contextPath}/resources/images/service/palyGround.png"
												class="png">
											<p>운동장</p>
										</div>
									</c:when>
						...
						<p class="font pb-3">
							판매자 정보 <span>
								<button type="button" class="btn text-white info"
									data-bs-toggle="modal" data-bs-target="#info">
									<img
										src="${pageContext.request.contextPath}/resources/images/right2.png"
										style="width: 18px;">
								</button>
							</span>
						</p>
							...
							<div class="modal-dialog">
								<div class="modal-content">
									<div class="modal-header">
										<h1 class="modal-title fs-5" id="staticBackdropLabel">판매자
											정보</h1>
					...
					<div
						...
						<div class="card-body">
							<form name="dateForm" action="roomInfo.do" method="get">
								<p class="cal">
									<i class="fa-regular fa-calendar fa-lg"></i>&nbsp;&nbsp; <input
										type="hidden" value="${companyNum}" name="companyNum">
									<input type="text" id="start_date" name="start_date"
										class="styleInput"> ~ <input type="text" id="end_date"
										name="end_date" class="styleInput">
								</p>
				...
				<div class="container mb-2 pt-3"
					style="width: 1100px; margin-left: 80px;">
