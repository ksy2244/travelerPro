...
public class AdminServlet extends TravelServlet {
	...
	protected void companyArticle(HttpServletRequest req, HttpServletResponse resp)
	...
	protected void companyUpdate(HttpServletRequest req, HttpServletResponse resp)
			throws ServletException, IOException {
		AdminDAO dao = new AdminDAO();
